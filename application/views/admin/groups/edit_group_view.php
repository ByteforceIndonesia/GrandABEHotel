	...
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4">
			...
			<div class="form-group">
				...
				<?php echo form_error('group_name','<div style="color:red;">','</div>');?>
			...
			<div class="form-group">
				...
				<?php echo form_error('group_description','<div style="color:red;">','</div>');?>
				<?php echo form_input('group_description',
				set_value('group_description',
				$group->description),'class="form-control"');?>
			</div>
