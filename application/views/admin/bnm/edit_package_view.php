...
<div class="container">
	<div class="col-lg-10 col-lg-offset-1">
		...
		<?php echo form_open_multipart('admin/bnm/editPackage/'.$package->id,array('class'=>'form-horizontal')); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					value="<?php echo set_value('ta_packageName', $package->name); ?>"
					>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">	
					<div class="input-group">
						...
						value="<?php echo set_value('txtpackage', $package->image); ?>"
						>
					</div>
				</div>	
				<div class="col-sm-5" >
					<div class="imgDiv">
						<img src="<?php echo base_url().'assets/images/uploads/packages/'.$package->image?>" id="img_package" >
					</div>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea id="ta_packageDesc" name="ta_packageDesc">
						<?php echo set_value('ta_packageDesc', $package->description); ?>
					</textarea>
				</div>
