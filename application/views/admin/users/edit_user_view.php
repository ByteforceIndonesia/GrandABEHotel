		...
		<div class="col-lg-4 col-lg-offset-4">
			...
			<div class="form-group">
				<?php
					...
					echo form_error('first_name','<div style="color:red;">','</div>');
			...
			<div class="form-group">
				<?php
					...
					echo form_error('last_name','<div style="color:red;">','</div>');
			...
			<div class="form-group">
				<?php
					...
					echo form_error('company','<div style="color:red;">','</div>');
			...
			<div class="form-group">
				<?php
					...
					echo form_error('password_confirm','<div style="color:red;">','</div>');
