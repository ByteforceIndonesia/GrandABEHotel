...
<div class="container">
	<div class="col-lg-10 col-lg-offset-1">
		...
		<?php echo form_open('admin/footer/editContact/'.$contact->id,array('class'=>'form-horizontal')); ?>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					value="<?php echo set_value('ta_socialMedia',$contact->socialmedia);?>"
					>
				</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					value="<?php echo set_value('ta_socialMedia',$contact->link);?>"
					>
				</div>
